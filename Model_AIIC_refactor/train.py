...
def build_parser():
    ...
    parser.add_argument('--runs', type=str, default=None, help='Comma-separated run names to keep from the resolved experiment plan')
    parser.add_argument('--override', action='append', default=None, help='Universal override in scope.path=value form; train supports task.*, model.*, training.*')
    parser.add_argument('--task_override', action='append', default=None, help='Compatibility alias for task-scoped override in key=value form; repeatable')
    parser.add_argument('--model_override', action='append', default=None, help='Experiment-wide model override applied after experiment resolution, repeatable key=value')
    parser.add_argument('--training_override', action='append', default=None, help='Experiment-wide training override applied after experiment resolution, repeatable key=value')
