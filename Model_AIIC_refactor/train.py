...
def build_parser():
    ...
    parser.add_argument('--model_override', action='append', default=None, help='Debug-only model override in key=value form; repeatable')
    parser.add_argument('--training_override', action='append', default=None, help='Debug-only training override in key=value form; repeatable')
