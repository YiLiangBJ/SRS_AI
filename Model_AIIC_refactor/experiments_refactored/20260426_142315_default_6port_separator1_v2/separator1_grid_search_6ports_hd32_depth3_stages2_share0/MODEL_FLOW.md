...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `54,048`
...
| `real_branch_hidden_1` | `[-1, 32]` | `per port, per stage (2 stages total)` | `800` | `9,600` | The first branch affine layer maps width 24 to hidden width 32. |
| `imag_branch_hidden_1` | `[-1, 32]` | `per port, per stage (2 stages total)` | `800` | `9,600` | The first branch affine layer maps width 24 to hidden width 32. |
| `real_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total)` | `396` | `4,752` | The real branch final affine layer reduces hidden width 32 to one real channel width 12. |
| `imag_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total)` | `396` | `4,752` | The imaginary branch final affine layer reduces hidden width 32 to one imaginary channel width 12. |
