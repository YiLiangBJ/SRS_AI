...
- Other scalar ops / sample: `169`
- FLOPs / sample estimate: `49,320`
...
| `hidden_relu` | `once per sample` | `0` | `0` | `0` | `0` | `144` | `144` | Optional hidden ReLU is applied before hidden residual correction. |
...
```json
{
  ...
  "other_scalar_ops_per_sample_estimate": 169,
  "other_scalar_ops_per_sample_estimate_string": "169",
  "flops_per_sample_estimate": 49320,
  "flops_per_sample_estimate_string": "49,320",
