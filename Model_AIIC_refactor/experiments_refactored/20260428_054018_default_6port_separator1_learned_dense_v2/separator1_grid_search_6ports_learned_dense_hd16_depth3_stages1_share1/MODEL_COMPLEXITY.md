...
- Parameter memory (FP32): `0.041 MiB (42,624 bytes)`
- MACs / sample: `9,984`
...
```json
{
  "trainable_parameters": 10656,
  "trainable_parameters_string": "10,656",
  "parameter_memory_bytes_fp32": 42624,
  "parameter_memory_bytes_fp32_string": "0.041 MiB (42,624 bytes)",
