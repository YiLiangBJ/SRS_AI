...
- Parameter memory (FP32): `0.109 MiB (114,816 bytes)`
- MACs / sample: `27,648`
- Multiplications / sample: `27,816`
- Additions / sample: `27,959`
...
| `real_linear_02` | `per port, per stage (6 ports x 1 stage executions)` | `4,680` | `4,608` | `4,608` | `4,608` | `0` | `9,216` | Real branch affine layer maps width 64 to width 12. |
...
| `imag_linear_02` | `per port, per stage (6 ports x 1 stage executions)` | `4,680` | `4,608` | `4,608` | `4,608` | `0` | `9,216` | Imag branch affine layer maps width 64 to width 12. |
...
```json
{
  "trainable_parameters": 28704,
  "trainable_parameters_string": "28,704",
  "parameter_memory_bytes_fp32": 114816,
  "parameter_memory_bytes_fp32_string": "0.109 MiB (114,816 bytes)",
  "macs_per_sample": 27648,
  "macs_per_sample_string": "27,648",
  "multiplications_per_sample": 27816,
  "multiplications_per_sample_string": "27,816",
  "additions_per_sample": 27959,
  "additions_per_sample_string": "27,959",
  "other_scalar_ops_per_sample_estimate": 793,
  "other_scalar_ops_per_sample_estimate_string": "793",
  "flops_per_sample_estimate": 56568,
  "flops_per_sample_estimate_string": "56,568",
