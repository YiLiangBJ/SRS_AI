...
- Parameter memory (FP32): `0.219 MiB (229,632 bytes)`
- MACs / sample: `55,296`
...
```json
{
  "trainable_parameters": 57408,
  "trainable_parameters_string": "57,408",
  "parameter_memory_bytes_fp32": 229632,
  "parameter_memory_bytes_fp32_string": "0.219 MiB (229,632 bytes)",
