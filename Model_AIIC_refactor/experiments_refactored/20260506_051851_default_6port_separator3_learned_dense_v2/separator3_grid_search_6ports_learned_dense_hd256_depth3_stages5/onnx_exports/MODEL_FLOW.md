...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `669,600`
...
| `stage_2_hidden_2` | `[-1, 256]` | `stage 2` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 2. |
| `stage_2_hidden_2_relu` | `[-1, 256]` | `stage 2` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
...
| `stage_3_hidden_2` | `[-1, 256]` | `stage 3` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 3. |
| `stage_3_hidden_2_relu` | `[-1, 256]` | `stage 3` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
...
| `stage_4_hidden_2` | `[-1, 256]` | `stage 4` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 4. |
| `stage_4_hidden_2_relu` | `[-1, 256]` | `stage 4` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
...
| `stage_5_hidden_2` | `[-1, 256]` | `stage 5` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 5. |
| `stage_5_hidden_2_relu` | `[-1, 256]` | `stage 5` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
