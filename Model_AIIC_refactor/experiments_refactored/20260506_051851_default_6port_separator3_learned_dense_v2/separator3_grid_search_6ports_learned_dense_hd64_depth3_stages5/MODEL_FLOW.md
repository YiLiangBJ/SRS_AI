...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `107,040`
...
| `stage_2_hidden_1` | `[-1, 64]` | `stage 2` | `9,280` | `9,280` | The first affine layer of stage 2 maps width 144 to hidden width 64. |
| `stage_2_hidden_1_relu` | `[-1, 64]` | `stage 2` | `0` | `0` | ReLU is applied after every hidden linear layer and keeps the hidden shape unchanged. |
| `stage_2_hidden_2` | `[-1, 64]` | `stage 2` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 2. |
| `stage_2_hidden_2_relu` | `[-1, 64]` | `stage 2` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_2_joint_output` | `[-1, 144]` | `stage 2` | `9,360` | `9,360` | The final affine layer of stage 2 maps hidden width 64 to expanded width 144 = num_ports * (2 * seq_len). |
...
| `stage_3_hidden_1` | `[-1, 64]` | `stage 3` | `9,280` | `9,280` | The first affine layer of stage 3 maps width 144 to hidden width 64. |
| `stage_3_hidden_1_relu` | `[-1, 64]` | `stage 3` | `0` | `0` | ReLU is applied after every hidden linear layer and keeps the hidden shape unchanged. |
| `stage_3_hidden_2` | `[-1, 64]` | `stage 3` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 3. |
| `stage_3_hidden_2_relu` | `[-1, 64]` | `stage 3` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_3_joint_output` | `[-1, 144]` | `stage 3` | `9,360` | `9,360` | The final affine layer of stage 3 maps hidden width 64 to expanded width 144 = num_ports * (2 * seq_len). |
...
| `stage_4_hidden_1` | `[-1, 64]` | `stage 4` | `9,280` | `9,280` | The first affine layer of stage 4 maps width 144 to hidden width 64. |
| `stage_4_hidden_1_relu` | `[-1, 64]` | `stage 4` | `0` | `0` | ReLU is applied after every hidden linear layer and keeps the hidden shape unchanged. |
| `stage_4_hidden_2` | `[-1, 64]` | `stage 4` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 4. |
| `stage_4_hidden_2_relu` | `[-1, 64]` | `stage 4` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_4_joint_output` | `[-1, 144]` | `stage 4` | `9,360` | `9,360` | The final affine layer of stage 4 maps hidden width 64 to expanded width 144 = num_ports * (2 * seq_len). |
...
| `stage_5_hidden_1` | `[-1, 64]` | `stage 5` | `9,280` | `9,280` | The first affine layer of stage 5 maps width 144 to hidden width 64. |
| `stage_5_hidden_1_relu` | `[-1, 64]` | `stage 5` | `0` | `0` | ReLU is applied after every hidden linear layer and keeps the hidden shape unchanged. |
| `stage_5_hidden_2` | `[-1, 64]` | `stage 5` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 5. |
| `stage_5_hidden_2_relu` | `[-1, 64]` | `stage 5` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_5_joint_output` | `[-1, 144]` | `stage 5` | `9,360` | `9,360` | The final affine layer of stage 5 maps hidden width 64 to expanded width 144 = num_ports * (2 * seq_len). |
