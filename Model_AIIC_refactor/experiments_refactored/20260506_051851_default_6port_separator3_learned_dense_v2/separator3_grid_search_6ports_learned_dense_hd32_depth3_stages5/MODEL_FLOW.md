...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `49,120`
...
| `stage_2_hidden_1` | `[-1, 32]` | `stage 2` | `4,640` | `4,640` | The first affine layer of stage 2 maps width 144 to hidden width 32. |
| `stage_2_hidden_1_relu` | `[-1, 32]` | `stage 2` | `0` | `0` | ReLU is applied after every hidden linear layer and keeps the hidden shape unchanged. |
| `stage_2_hidden_2` | `[-1, 32]` | `stage 2` | `1,056` | `1,056` | This affine layer keeps hidden width 32 inside stage 2. |
| `stage_2_hidden_2_relu` | `[-1, 32]` | `stage 2` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_2_joint_output` | `[-1, 144]` | `stage 2` | `4,752` | `4,752` | The final affine layer of stage 2 maps hidden width 32 to expanded width 144 = num_ports * (2 * seq_len). |
...
| `stage_3_hidden_1` | `[-1, 32]` | `stage 3` | `4,640` | `4,640` | The first affine layer of stage 3 maps width 144 to hidden width 32. |
| `stage_3_hidden_1_relu` | `[-1, 32]` | `stage 3` | `0` | `0` | ReLU is applied after every hidden linear layer and keeps the hidden shape unchanged. |
| `stage_3_hidden_2` | `[-1, 32]` | `stage 3` | `1,056` | `1,056` | This affine layer keeps hidden width 32 inside stage 3. |
| `stage_3_hidden_2_relu` | `[-1, 32]` | `stage 3` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_3_joint_output` | `[-1, 144]` | `stage 3` | `4,752` | `4,752` | The final affine layer of stage 3 maps hidden width 32 to expanded width 144 = num_ports * (2 * seq_len). |
...
| `stage_4_hidden_1` | `[-1, 32]` | `stage 4` | `4,640` | `4,640` | The first affine layer of stage 4 maps width 144 to hidden width 32. |
| `stage_4_hidden_1_relu` | `[-1, 32]` | `stage 4` | `0` | `0` | ReLU is applied after every hidden linear layer and keeps the hidden shape unchanged. |
| `stage_4_hidden_2` | `[-1, 32]` | `stage 4` | `1,056` | `1,056` | This affine layer keeps hidden width 32 inside stage 4. |
| `stage_4_hidden_2_relu` | `[-1, 32]` | `stage 4` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_4_joint_output` | `[-1, 144]` | `stage 4` | `4,752` | `4,752` | The final affine layer of stage 4 maps hidden width 32 to expanded width 144 = num_ports * (2 * seq_len). |
...
| `stage_5_hidden_1` | `[-1, 32]` | `stage 5` | `4,640` | `4,640` | The first affine layer of stage 5 maps width 144 to hidden width 32. |
| `stage_5_hidden_1_relu` | `[-1, 32]` | `stage 5` | `0` | `0` | ReLU is applied after every hidden linear layer and keeps the hidden shape unchanged. |
| `stage_5_hidden_2` | `[-1, 32]` | `stage 5` | `1,056` | `1,056` | This affine layer keeps hidden width 32 inside stage 5. |
| `stage_5_hidden_2_relu` | `[-1, 32]` | `stage 5` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_5_joint_output` | `[-1, 144]` | `stage 5` | `4,752` | `4,752` | The final affine layer of stage 5 maps hidden width 32 to expanded width 144 = num_ports * (2 * seq_len). |
