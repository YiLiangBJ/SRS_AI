...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `61,152`
- Dynamic dimensions: Dynamic dimensions are written as -1.

## Flow Summary

3 joint refinement stages; stage 1 maps 24 to 144, later stages map 144 to 144, and every stage ends with learned-dense residual correction.
