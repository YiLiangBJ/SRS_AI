...
- Parameter memory (FP32): `0.967 MiB (1,014,400 bytes)`
- MACs / sample: `250,880`
- Multiplications / sample: `251,048`
- Additions / sample: `252,343`
...
| `stage_05_hidden_linear_01` | `once per sample` | `18,560` | `18,432` | `18,432` | `18,432` | `0` | `36,864` | Stage 5 first affine layer maps width 144 to hidden width 128. |
| `stage_05_hidden_relu_01` | `once per sample` | `0` | `0` | `0` | `0` | `128` | `128` | Stage 5 applies ReLU after the first hidden affine layer. |
| `stage_05_hidden_linear_02` | `once per sample` | `16,512` | `16,384` | `16,384` | `16,384` | `0` | `32,768` | Stage 5 additional hidden affine layer keeps width 128. |
| `stage_05_hidden_relu_02` | `once per sample` | `0` | `0` | `0` | `0` | `128` | `128` | Stage 5 applies ReLU after hidden affine layer 2. |
| `stage_05_joint_output` | `once per sample` | `18,576` | `18,432` | `18,432` | `18,432` | `0` | `36,864` | Stage 5 output affine layer maps hidden width 128 to expanded width 144. |
...
```json
{
  "trainable_parameters": 253600,
  "trainable_parameters_string": "253,600",
  "parameter_memory_bytes_fp32": 1014400,
  "parameter_memory_bytes_fp32_string": "0.967 MiB (1,014,400 bytes)",
  "macs_per_sample": 250880,
  "macs_per_sample_string": "250,880",
  "multiplications_per_sample": 251048,
  "multiplications_per_sample_string": "251,048",
  "additions_per_sample": 252343,
  "additions_per_sample_string": "252,343",
  "other_scalar_ops_per_sample_estimate": 1305,
  "other_scalar_ops_per_sample_estimate_string": "1,305",
  "flops_per_sample_estimate": 504696,
  "flops_per_sample_estimate_string": "504,696",
