...
- Evaluation name: `20260422_011930_20-runs`
- Run count: 20
...
|---|---|---|---|---|---|---|---|---|
| 1 | `full_mlp_capacity_search_hd128_depth5` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd128_depth5` | `supervised_nmse_plateau` | -9.36 | -24.91 | 1.81 | 33 |
| 2 | `full_mlp_capacity_search_hd256_depth5` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd256_depth5` | `supervised_nmse_plateau` | -9.32 | -24.19 | 1.74 | 33 |
...
| 4 | `full_mlp_capacity_search_hd256_depth4` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd256_depth4` | `supervised_nmse_plateau` | -9.17 | -22.82 | 1.93 | 33 |
...
| 8 | `full_mlp_capacity_search_hd64_depth5` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd64_depth5` | `supervised_nmse_plateau` | -8.81 | -20.61 | 2.30 | 33 |
| 9 | `full_mlp_capacity_search_hd64_depth4` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd64_depth4` | `supervised_nmse_plateau` | -8.66 | -19.82 | 2.27 | 33 |
...
| 12 | `full_mlp_capacity_search_hd32_depth3` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd32_depth3` | `supervised_nmse_plateau` | -8.23 | -16.37 | 2.26 | 33 |
...
| 14 | `full_mlp_capacity_search_hd128_depth2` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd128_depth2` | `supervised_nmse_plateau` | -8.20 | -16.17 | 2.27 | 33 |
| 15 | `full_mlp_capacity_search_hd32_depth2` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd32_depth2` | `supervised_nmse_plateau` | -8.20 | -16.15 | 2.26 | 33 |
| 16 | `full_mlp_capacity_search_hd256_depth2` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd256_depth2` | `supervised_nmse_plateau` | -8.20 | -16.13 | 2.28 | 33 |
| 17 | `full_mlp_capacity_search_hd512_depth2` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd512_depth2` | `supervised_nmse_plateau` | -8.19 | -16.14 | 2.27 | 33 |
...
| 19 | `full_mlp_capacity_search_hd512_depth4` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd512_depth4` | `supervised_nmse_plateau` | -7.50 | -14.29 | 0.67 | 33 |
| 20 | `full_mlp_capacity_search_hd512_depth5` | `channel_separator_6port_standard` | `full_mlp_capacity_search_hd512_depth5` | `supervised_nmse_plateau` | -6.27 | -11.36 | 1.75 | 33 |
