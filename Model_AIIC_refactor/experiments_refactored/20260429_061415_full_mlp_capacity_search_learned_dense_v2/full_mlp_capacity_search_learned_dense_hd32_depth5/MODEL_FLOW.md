...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `7,808`
...
| `joint_hidden_1` | `[-1, 32]` | `-` | `800` | `800` | The first affine layer maps the input width 24 into the configured hidden width 32. |
| `joint_hidden_1_relu` | `[-1, 32]` | `-` | `0` | `0` | ReLU is elementwise, so it keeps the hidden shape unchanged. |
| `joint_hidden_2` | `[-1, 32]` | `-` | `1,056` | `1,056` | This affine layer keeps the same hidden width 32 while adding capacity. |
| `joint_hidden_2_relu` | `[-1, 32]` | `-` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `joint_hidden_3` | `[-1, 32]` | `-` | `1,056` | `1,056` | This affine layer keeps the same hidden width 32 while adding capacity. |
| `joint_hidden_3_relu` | `[-1, 32]` | `-` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `joint_linear_output` | `[-1, 144]` | `-` | `4,752` | `4,752` | The output affine layer expands hidden width 32 to flat joint output width 144. |
