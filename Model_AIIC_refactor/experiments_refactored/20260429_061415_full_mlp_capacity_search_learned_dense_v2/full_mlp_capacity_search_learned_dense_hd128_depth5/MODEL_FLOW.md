...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `54,944`
...
| `joint_hidden_1` | `[-1, 128]` | `-` | `3,200` | `3,200` | The first affine layer maps the input width 24 into the configured hidden width 128. |
| `joint_hidden_1_relu` | `[-1, 128]` | `-` | `0` | `0` | ReLU is elementwise, so it keeps the hidden shape unchanged. |
| `joint_hidden_2` | `[-1, 128]` | `-` | `16,512` | `16,512` | This affine layer keeps the same hidden width 128 while adding capacity. |
| `joint_hidden_2_relu` | `[-1, 128]` | `-` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `joint_hidden_3` | `[-1, 128]` | `-` | `16,512` | `16,512` | This affine layer keeps the same hidden width 128 while adding capacity. |
| `joint_hidden_3_relu` | `[-1, 128]` | `-` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `joint_linear_output` | `[-1, 144]` | `-` | `18,576` | `18,576` | The output affine layer expands hidden width 128 to flat joint output width 144. |
