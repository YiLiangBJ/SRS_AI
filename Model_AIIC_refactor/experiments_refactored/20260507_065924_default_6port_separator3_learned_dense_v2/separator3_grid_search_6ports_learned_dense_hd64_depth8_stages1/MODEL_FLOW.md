...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `36,064`
...
| `stage_1_hidden_3` | `[-1, 64]` | `once` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 1. |
| `stage_1_hidden_3_relu` | `[-1, 64]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_4` | `[-1, 64]` | `once` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 1. |
| `stage_1_hidden_4_relu` | `[-1, 64]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_5` | `[-1, 64]` | `once` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 1. |
| `stage_1_hidden_5_relu` | `[-1, 64]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_6` | `[-1, 64]` | `once` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 1. |
| `stage_1_hidden_6_relu` | `[-1, 64]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_7` | `[-1, 64]` | `once` | `4,160` | `4,160` | This affine layer keeps hidden width 64 inside stage 1. |
| `stage_1_hidden_7_relu` | `[-1, 64]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
