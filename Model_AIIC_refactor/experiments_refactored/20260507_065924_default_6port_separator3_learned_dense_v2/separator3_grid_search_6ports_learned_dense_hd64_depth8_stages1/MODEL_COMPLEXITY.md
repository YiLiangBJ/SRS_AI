...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `36,064`
- Parameter memory (FP32): `0.138 MiB (144,256 bytes)`
- MACs / sample: `35,328`
- Multiplications / sample: `35,496`
- Additions / sample: `35,639`
- Other scalar ops / sample: `473`
- FLOPs / sample estimate: `71,608`
...
| `stage_01_hidden_linear_06` | `once per sample` | `4,160` | `4,096` | `4,096` | `4,096` | `0` | `8,192` | Stage 1 additional hidden affine layer keeps width 64. |
| `stage_01_hidden_relu_06` | `once per sample` | `0` | `0` | `0` | `0` | `64` | `64` | Stage 1 applies ReLU after hidden affine layer 6. |
| `stage_01_hidden_linear_07` | `once per sample` | `4,160` | `4,096` | `4,096` | `4,096` | `0` | `8,192` | Stage 1 additional hidden affine layer keeps width 64. |
| `stage_01_hidden_relu_07` | `once per sample` | `0` | `0` | `0` | `0` | `64` | `64` | Stage 1 applies ReLU after hidden affine layer 7. |
...
```json
{
  "trainable_parameters": 36064,
  "trainable_parameters_string": "36,064",
  "parameter_memory_bytes_fp32": 144256,
  "parameter_memory_bytes_fp32_string": "0.138 MiB (144,256 bytes)",
  "macs_per_sample": 35328,
  "macs_per_sample_string": "35,328",
  "multiplications_per_sample": 35496,
  "multiplications_per_sample_string": "35,496",
  "additions_per_sample": 35639,
  "additions_per_sample_string": "35,639",
  "other_scalar_ops_per_sample_estimate": 473,
  "other_scalar_ops_per_sample_estimate_string": "473",
  "flops_per_sample_estimate": 71608,
  "flops_per_sample_estimate_string": "71,608",
