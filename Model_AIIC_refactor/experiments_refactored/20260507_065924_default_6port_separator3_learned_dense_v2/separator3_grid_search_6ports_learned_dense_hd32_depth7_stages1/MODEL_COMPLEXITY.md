...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `10,976`
- Parameter memory (FP32): `0.042 MiB (43,904 bytes)`
- MACs / sample: `10,496`
- Multiplications / sample: `10,664`
- Additions / sample: `10,807`
- Other scalar ops / sample: `217`
- FLOPs / sample estimate: `21,688`
...
```json
{
  "trainable_parameters": 10976,
  "trainable_parameters_string": "10,976",
  "parameter_memory_bytes_fp32": 43904,
  "parameter_memory_bytes_fp32_string": "0.042 MiB (43,904 bytes)",
  "macs_per_sample": 10496,
  "macs_per_sample_string": "10,496",
  "multiplications_per_sample": 10664,
  "multiplications_per_sample_string": "10,664",
  "additions_per_sample": 10807,
  "additions_per_sample_string": "10,807",
  "other_scalar_ops_per_sample_estimate": 217,
  "other_scalar_ops_per_sample_estimate_string": "217",
  "flops_per_sample_estimate": 21688,
  "flops_per_sample_estimate_string": "21,688",
