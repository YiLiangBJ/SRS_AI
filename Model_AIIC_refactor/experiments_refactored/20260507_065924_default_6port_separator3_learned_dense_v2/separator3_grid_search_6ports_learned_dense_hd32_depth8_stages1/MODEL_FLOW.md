...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `12,032`
...
| `stage_1_hidden_7` | `[-1, 32]` | `once` | `1,056` | `1,056` | This affine layer keeps hidden width 32 inside stage 1. |
| `stage_1_hidden_7_relu` | `[-1, 32]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
