...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `438,304`
...
| `stage_1_hidden_2` | `[-1, 256]` | `once` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 1. |
| `stage_1_hidden_2_relu` | `[-1, 256]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_3` | `[-1, 256]` | `once` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 1. |
| `stage_1_hidden_3_relu` | `[-1, 256]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_4` | `[-1, 256]` | `once` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 1. |
| `stage_1_hidden_4_relu` | `[-1, 256]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_5` | `[-1, 256]` | `once` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 1. |
| `stage_1_hidden_5_relu` | `[-1, 256]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_6` | `[-1, 256]` | `once` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 1. |
| `stage_1_hidden_6_relu` | `[-1, 256]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_7` | `[-1, 256]` | `once` | `65,792` | `65,792` | This affine layer keeps hidden width 256 inside stage 1. |
| `stage_1_hidden_7_relu` | `[-1, 256]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
