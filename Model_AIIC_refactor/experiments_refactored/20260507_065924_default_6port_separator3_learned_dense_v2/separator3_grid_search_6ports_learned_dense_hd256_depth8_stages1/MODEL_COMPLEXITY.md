...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `438,304`
- Parameter memory (FP32): `1.672 MiB (1,753,216 bytes)`
- MACs / sample: `436,224`
- Multiplications / sample: `436,392`
- Additions / sample: `436,535`
- Other scalar ops / sample: `1,817`
- FLOPs / sample estimate: `874,744`
...
| `stage_01_hidden_linear_04` | `once per sample` | `65,792` | `65,536` | `65,536` | `65,536` | `0` | `131,072` | Stage 1 additional hidden affine layer keeps width 256. |
| `stage_01_hidden_relu_04` | `once per sample` | `0` | `0` | `0` | `0` | `256` | `256` | Stage 1 applies ReLU after hidden affine layer 4. |
| `stage_01_hidden_linear_05` | `once per sample` | `65,792` | `65,536` | `65,536` | `65,536` | `0` | `131,072` | Stage 1 additional hidden affine layer keeps width 256. |
| `stage_01_hidden_relu_05` | `once per sample` | `0` | `0` | `0` | `0` | `256` | `256` | Stage 1 applies ReLU after hidden affine layer 5. |
| `stage_01_hidden_linear_06` | `once per sample` | `65,792` | `65,536` | `65,536` | `65,536` | `0` | `131,072` | Stage 1 additional hidden affine layer keeps width 256. |
| `stage_01_hidden_relu_06` | `once per sample` | `0` | `0` | `0` | `0` | `256` | `256` | Stage 1 applies ReLU after hidden affine layer 6. |
| `stage_01_hidden_linear_07` | `once per sample` | `65,792` | `65,536` | `65,536` | `65,536` | `0` | `131,072` | Stage 1 additional hidden affine layer keeps width 256. |
| `stage_01_hidden_relu_07` | `once per sample` | `0` | `0` | `0` | `0` | `256` | `256` | Stage 1 applies ReLU after hidden affine layer 7. |
...
```json
{
  "trainable_parameters": 438304,
  "trainable_parameters_string": "438,304",
  "parameter_memory_bytes_fp32": 1753216,
  "parameter_memory_bytes_fp32_string": "1.672 MiB (1,753,216 bytes)",
  "macs_per_sample": 436224,
  "macs_per_sample_string": "436,224",
  "multiplications_per_sample": 436392,
  "multiplications_per_sample_string": "436,392",
  "additions_per_sample": 436535,
  "additions_per_sample_string": "436,535",
  "other_scalar_ops_per_sample_estimate": 1817,
  "other_scalar_ops_per_sample_estimate_string": "1,817",
  "flops_per_sample_estimate": 874744,
  "flops_per_sample_estimate_string": "874,744",
