...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `31,904`
- Parameter memory (FP32): `0.122 MiB (127,616 bytes)`
- MACs / sample: `31,232`
- Multiplications / sample: `31,400`
- Additions / sample: `31,543`
- Other scalar ops / sample: `409`
- FLOPs / sample estimate: `63,352`
...
```json
{
  "trainable_parameters": 31904,
  "trainable_parameters_string": "31,904",
  "parameter_memory_bytes_fp32": 127616,
  "parameter_memory_bytes_fp32_string": "0.122 MiB (127,616 bytes)",
  "macs_per_sample": 31232,
  "macs_per_sample_string": "31,232",
  "multiplications_per_sample": 31400,
  "multiplications_per_sample_string": "31,400",
  "additions_per_sample": 31543,
  "additions_per_sample_string": "31,543",
  "other_scalar_ops_per_sample_estimate": 409,
  "other_scalar_ops_per_sample_estimate_string": "409",
  "flops_per_sample_estimate": 63352,
  "flops_per_sample_estimate_string": "63,352",
