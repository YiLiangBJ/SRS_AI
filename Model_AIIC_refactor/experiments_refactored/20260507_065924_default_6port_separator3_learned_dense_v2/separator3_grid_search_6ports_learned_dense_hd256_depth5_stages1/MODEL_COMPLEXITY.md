...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `240,928`
- Parameter memory (FP32): `0.919 MiB (963,712 bytes)`
- MACs / sample: `239,616`
- Multiplications / sample: `239,784`
- Additions / sample: `239,927`
- Other scalar ops / sample: `1,049`
- FLOPs / sample estimate: `480,760`
...
```json
{
  "trainable_parameters": 240928,
  "trainable_parameters_string": "240,928",
  "parameter_memory_bytes_fp32": 963712,
  "parameter_memory_bytes_fp32_string": "0.919 MiB (963,712 bytes)",
  "macs_per_sample": 239616,
  "macs_per_sample_string": "239,616",
  "multiplications_per_sample": 239784,
  "multiplications_per_sample_string": "239,784",
  "additions_per_sample": 239927,
  "additions_per_sample_string": "239,927",
  "other_scalar_ops_per_sample_estimate": 1049,
  "other_scalar_ops_per_sample_estimate_string": "1,049",
  "flops_per_sample_estimate": 480760,
  "flops_per_sample_estimate_string": "480,760",
