...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `120,992`
...
| `stage_1_hidden_3` | `[-1, 128]` | `once` | `16,512` | `16,512` | This affine layer keeps hidden width 128 inside stage 1. |
| `stage_1_hidden_3_relu` | `[-1, 128]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_4` | `[-1, 128]` | `once` | `16,512` | `16,512` | This affine layer keeps hidden width 128 inside stage 1. |
| `stage_1_hidden_4_relu` | `[-1, 128]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_5` | `[-1, 128]` | `once` | `16,512` | `16,512` | This affine layer keeps hidden width 128 inside stage 1. |
| `stage_1_hidden_5_relu` | `[-1, 128]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_6` | `[-1, 128]` | `once` | `16,512` | `16,512` | This affine layer keeps hidden width 128 inside stage 1. |
| `stage_1_hidden_6_relu` | `[-1, 128]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
| `stage_1_hidden_7` | `[-1, 128]` | `once` | `16,512` | `16,512` | This affine layer keeps hidden width 128 inside stage 1. |
| `stage_1_hidden_7_relu` | `[-1, 128]` | `once` | `0` | `0` | ReLU is elementwise, so the hidden width stays the same. |
