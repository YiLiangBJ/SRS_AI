...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `38,432`
- Parameter memory (FP32): `0.147 MiB (153,728 bytes)`
- MACs / sample: `37,888`
- Multiplications / sample: `38,056`
- Additions / sample: `38,199`
- Other scalar ops / sample: `281`
- FLOPs / sample estimate: `76,536`
...
```json
{
  "trainable_parameters": 38432,
  "trainable_parameters_string": "38,432",
  "parameter_memory_bytes_fp32": 153728,
  "parameter_memory_bytes_fp32_string": "0.147 MiB (153,728 bytes)",
  ...
  "additions_per_sample": 38199,
  "additions_per_sample_string": "38,199",
  "other_scalar_ops_per_sample_estimate": 281,
  "other_scalar_ops_per_sample_estimate_string": "281",
  "flops_per_sample_estimate": 76536,
  "flops_per_sample_estimate_string": "76,536",
