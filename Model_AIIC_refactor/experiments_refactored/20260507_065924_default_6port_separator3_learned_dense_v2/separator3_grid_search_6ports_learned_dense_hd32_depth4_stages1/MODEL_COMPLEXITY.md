...
- Additions / sample: `7,735`
- Other scalar ops / sample: `121`
- FLOPs / sample estimate: `15,448`
...
```json
{
  ...
  "additions_per_sample": 7735,
  "additions_per_sample_string": "7,735",
  "other_scalar_ops_per_sample_estimate": 121,
  "other_scalar_ops_per_sample_estimate_string": "121",
  "flops_per_sample_estimate": 15448,
  "flops_per_sample_estimate_string": "15,448",
