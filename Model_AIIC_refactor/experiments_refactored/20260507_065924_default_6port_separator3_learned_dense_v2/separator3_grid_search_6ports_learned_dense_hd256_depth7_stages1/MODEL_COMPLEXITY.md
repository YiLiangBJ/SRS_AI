...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `372,512`
- Parameter memory (FP32): `1.421 MiB (1,490,048 bytes)`
- MACs / sample: `370,688`
- Multiplications / sample: `370,856`
- Additions / sample: `370,999`
- Other scalar ops / sample: `1,561`
- FLOPs / sample estimate: `743,416`
...
```json
{
  "trainable_parameters": 372512,
  "trainable_parameters_string": "372,512",
  "parameter_memory_bytes_fp32": 1490048,
  "parameter_memory_bytes_fp32_string": "1.421 MiB (1,490,048 bytes)",
  "macs_per_sample": 370688,
  "macs_per_sample_string": "370,688",
  "multiplications_per_sample": 370856,
  "multiplications_per_sample_string": "370,856",
  "additions_per_sample": 370999,
  "additions_per_sample_string": "370,999",
  "other_scalar_ops_per_sample_estimate": 1561,
  "other_scalar_ops_per_sample_estimate_string": "1,561",
  "flops_per_sample_estimate": 743416,
  "flops_per_sample_estimate_string": "743,416",
