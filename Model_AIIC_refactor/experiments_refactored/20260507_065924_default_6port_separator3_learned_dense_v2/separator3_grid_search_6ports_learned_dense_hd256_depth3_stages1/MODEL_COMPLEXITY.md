...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `109,344`
- Parameter memory (FP32): `0.417 MiB (437,376 bytes)`
- MACs / sample: `108,544`
- Multiplications / sample: `108,712`
- Additions / sample: `108,855`
- Other scalar ops / sample: `537`
- FLOPs / sample estimate: `218,104`
...
```json
{
  "trainable_parameters": 109344,
  "trainable_parameters_string": "109,344",
  "parameter_memory_bytes_fp32": 437376,
  "parameter_memory_bytes_fp32_string": "0.417 MiB (437,376 bytes)",
  ...
  "additions_per_sample": 108855,
  "additions_per_sample_string": "108,855",
  "other_scalar_ops_per_sample_estimate": 537,
  "other_scalar_ops_per_sample_estimate_string": "537",
  "flops_per_sample_estimate": 218104,
  "flops_per_sample_estimate_string": "218,104",
