...
- Input shape: `[-1, 24]`
- Output shape: `[-1, 6, 24]`
- Trainable parameters: `104,480`
- Parameter memory (FP32): `0.399 MiB (417,920 bytes)`
- MACs / sample: `103,424`
- Multiplications / sample: `103,592`
- Additions / sample: `103,735`
- Other scalar ops / sample: `793`
- FLOPs / sample estimate: `208,120`
...
```json
{
  "trainable_parameters": 104480,
  "trainable_parameters_string": "104,480",
  "parameter_memory_bytes_fp32": 417920,
  "parameter_memory_bytes_fp32_string": "0.399 MiB (417,920 bytes)",
  "macs_per_sample": 103424,
  "macs_per_sample_string": "103,424",
  "multiplications_per_sample": 103592,
  "multiplications_per_sample_string": "103,592",
  "additions_per_sample": 103735,
  "additions_per_sample_string": "103,735",
  "other_scalar_ops_per_sample_estimate": 793,
  "other_scalar_ops_per_sample_estimate_string": "793",
  "flops_per_sample_estimate": 208120,
  "flops_per_sample_estimate_string": "208,120",
