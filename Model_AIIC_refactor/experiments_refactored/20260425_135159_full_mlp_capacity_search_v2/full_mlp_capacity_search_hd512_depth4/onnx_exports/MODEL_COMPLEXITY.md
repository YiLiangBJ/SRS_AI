...
- Parameter memory (FP32): `1.333 MiB (1,397,312 bytes)`
- MACs / sample: `348,160`
...
```json
{
  "trainable_parameters": 349328,
  "trainable_parameters_string": "349,328",
  "parameter_memory_bytes_fp32": 1397312,
  "parameter_memory_bytes_fp32_string": "1.333 MiB (1,397,312 bytes)",
