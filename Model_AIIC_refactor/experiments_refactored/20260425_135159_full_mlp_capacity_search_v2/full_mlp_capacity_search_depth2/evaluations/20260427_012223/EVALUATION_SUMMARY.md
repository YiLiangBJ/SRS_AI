...
- Evaluation name: `20260427_012223`
- Run count: 1
...
|---|---|---|---|---|---|---|---|---|
| 1 | `full_mlp_capacity_search_depth2` | `channel_separator_6port_standard` | `full_mlp_capacity_search_depth2` | `supervised_nmse_plateau` | -9.52 | -16.17 | 2.07 | 11 |
...
- Model: `full_mlp_capacity_search_depth2`
