...
- Parameter memory (FP32): `0.209 MiB (219,200 bytes)`
- MACs / sample: `54,272`
...
```json
{
  "trainable_parameters": 54800,
  "trainable_parameters_string": "54,800",
  "parameter_memory_bytes_fp32": 219200,
  "parameter_memory_bytes_fp32_string": "0.209 MiB (219,200 bytes)",
