...
- Parameter memory (FP32): `0.668 MiB (699,968 bytes)`
- MACs / sample: `174,080`
...
```json
{
  "trainable_parameters": 174992,
  "trainable_parameters_string": "174,992",
  "parameter_memory_bytes_fp32": 699968,
  "parameter_memory_bytes_fp32_string": "0.668 MiB (699,968 bytes)",
