...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `21,024`
...
| `real_branch_hidden_1` | `[-1, 16]` | `per port, per stage (2 stages total)` | `400` | `4,800` | The first branch affine layer maps width 24 to hidden width 16. |
| `imag_branch_hidden_1` | `[-1, 16]` | `per port, per stage (2 stages total)` | `400` | `4,800` | The first branch affine layer maps width 24 to hidden width 16. |
| `real_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total)` | `204` | `2,448` | The real branch final affine layer reduces hidden width 16 to one real channel width 12. |
| `imag_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total)` | `204` | `2,448` | The imaginary branch final affine layer reduces hidden width 16 to one imaginary channel width 12. |
