...
| `real_branch_hidden_1` | `[-1, 128]` | `per port, per stage (2 stages total, stage weights shared)` | `3,200` | `19,200` | The first branch affine layer maps width 24 to hidden width 128. |
| `imag_branch_hidden_1` | `[-1, 128]` | `per port, per stage (2 stages total, stage weights shared)` | `3,200` | `19,200` | The first branch affine layer maps width 24 to hidden width 128. |
| `real_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total, stage weights shared)` | `1,548` | `9,288` | The real branch final affine layer reduces hidden width 128 to one real channel width 12. |
| `imag_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total, stage weights shared)` | `1,548` | `9,288` | The imaginary branch final affine layer reduces hidden width 128 to one imaginary channel width 12. |
