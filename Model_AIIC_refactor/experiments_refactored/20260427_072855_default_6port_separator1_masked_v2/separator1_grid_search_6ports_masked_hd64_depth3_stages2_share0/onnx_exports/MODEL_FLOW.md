...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `156,960`
...
| `real_branch_hidden_1` | `[-1, 64]` | `per port, per stage (2 stages total)` | `1,600` | `19,200` | The first branch affine layer maps width 24 to hidden width 64. |
| `imag_branch_hidden_1` | `[-1, 64]` | `per port, per stage (2 stages total)` | `1,600` | `19,200` | The first branch affine layer maps width 24 to hidden width 64. |
| `real_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total)` | `780` | `9,360` | The real branch final affine layer reduces hidden width 64 to one real channel width 12. |
| `imag_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total)` | `780` | `9,360` | The imaginary branch final affine layer reduces hidden width 64 to one imaginary channel width 12. |
