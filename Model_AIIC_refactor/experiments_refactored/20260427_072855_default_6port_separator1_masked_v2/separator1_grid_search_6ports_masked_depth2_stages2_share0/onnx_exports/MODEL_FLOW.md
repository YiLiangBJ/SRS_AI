...
- Output shape: `[-1, 6, 24]`
- Total trainable parameters: `57,120`
...
| `real_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total)` | `300` | `3,600` | The real branch projects one width-24 input directly down to one real channel width 12. |
| `imag_branch_output` | `[-1, 12]` | `per port, per stage (2 stages total)` | `300` | `3,600` | The imaginary branch projects one width-24 input directly down to one imaginary channel width 12. |
