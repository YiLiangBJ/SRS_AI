...
- Parameter memory (FP32): `0.042 MiB (43,840 bytes)`
- MACs / sample: `10,752`
- Multiplications / sample: `10,920`
- Additions / sample: `10,775`
...
| `joint_linear_02` | `once per sample` | `9,360` | `9,216` | `9,216` | `9,216` | `0` | `18,432` | Joint affine layer maps width 64 to width 144. |

## Raw Summary

```json
{
  "trainable_parameters": 10960,
  "trainable_parameters_string": "10,960",
  "parameter_memory_bytes_fp32": 43840,
  "parameter_memory_bytes_fp32_string": "0.042 MiB (43,840 bytes)",
  ...
  "additions_per_sample": 10775,
  "additions_per_sample_string": "10,775",
  "other_scalar_ops_per_sample_estimate": 89,
  "other_scalar_ops_per_sample_estimate_string": "89",
  "flops_per_sample_estimate": 21784,
  "flops_per_sample_estimate_string": "21,784",
