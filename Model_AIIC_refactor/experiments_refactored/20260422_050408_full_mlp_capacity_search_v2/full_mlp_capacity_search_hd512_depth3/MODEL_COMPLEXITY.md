...
- Parameter memory (FP32): `0.331 MiB (346,688 bytes)`
- MACs / sample: `86,016`
...
```json
{
  "trainable_parameters": 86672,
  "trainable_parameters_string": "86,672",
  "parameter_memory_bytes_fp32": 346688,
  "parameter_memory_bytes_fp32_string": "0.331 MiB (346,688 bytes)",
