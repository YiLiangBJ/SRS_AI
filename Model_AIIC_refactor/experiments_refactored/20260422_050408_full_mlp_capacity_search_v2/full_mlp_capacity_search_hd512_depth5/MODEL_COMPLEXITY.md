...
- Parameter memory (FP32): `2.335 MiB (2,447,936 bytes)`
- MACs / sample: `610,304`
...
```json
{
  "trainable_parameters": 611984,
  "trainable_parameters_string": "611,984",
  "parameter_memory_bytes_fp32": 2447936,
  "parameter_memory_bytes_fp32_string": "2.335 MiB (2,447,936 bytes)",
